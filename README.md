...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fcypriot-data-protection-mcp.svg)](https://www.npmjs.com/package/@ansvar/cypriot-data-protection-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/cypriot-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add cypriot-data-protection-mcp --transport http https://mcp.ansvar.eu/cypriot-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "cypriot-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/cypriot-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/cypriot-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "cypriot-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/cypriot-data-protection-mcp"]
    }
  }
}
```
