...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CDPC (Commissioner for Personal Data Protection) decisions and sanctions.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Search CDPC guidance documents on GDPR implementation in Cyprus.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific CDPC guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
      ...
      switch (name) {
        ...
        case "cy_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "CDPC (Commissioner for Personal Data Protection) MCP server. Provides access to Cypriot data protection authority decisions and guidance.",
